...
namespace Crystall {
    ...
    namespace Evaluation {
        ...
        constexpr static int MGTables[6][64] = {
            // pawn
            {
                 0,  0,  0,  0,  0,  0,  0,  0,
        ...
        constexpr static int EGTables[6][64] = {
            // pawn
            {
                 0,  0,  0,  0,  0,  0,  0,  0,
                50, 50, 50, 50, 50, 50, 50, 50,
    ...
    class Evaluator {
        ...
        int calculate_phase(const Position& pos) const;

        int calculate_psqt(int phase) const {
            return (phase * psqt_mg + (MAX_PHASE - phase) * psqt_eg) / MAX_PHASE;
        }

        constexpr static int PAWN_VALUE_MG = 82, KNIGHT_VALUE_MG = 337, BISHOP_VALUE_MG = 365, ROOK_VALUE_MG = 477, QUEEN_VALUE_MG = 1025,
                             PAWN_VALUE_EG = 94, KNIGHT_VALUE_EG = 281, BISHOP_VALUE_EG = 297, ROOK_VALUE_EG = 512, QUEEN_VALUE_EG =  936;
        constexpr static int MGValues[PIECETYPE_NB] = {PAWN_VALUE_MG, KNIGHT_VALUE_MG, BISHOP_VALUE_MG, ROOK_VALUE_MG, QUEEN_VALUE_MG};
        constexpr static int EGValues[PIECETYPE_NB] = {PAWN_VALUE_EG, KNIGHT_VALUE_EG, BISHOP_VALUE_EG, ROOK_VALUE_EG, QUEEN_VALUE_EG};
        ...
        private:
        constexpr static int PhaseInc[PIECE_NB] = {0, 0, 1, 1, 1, 1, 2, 2, 4, 4, 0, 0}; 
        constexpr static int MAX_PHASE = 24;
    };*/
}
